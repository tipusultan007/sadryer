        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    <!-- Page pre-title -->
                    <h2 class="page-title">
                        আয় ক্যাটেগরি - {{ $incomeCategory->name }}
                    </h2>
                </div>
                <!-- Page title actions -->
...
@section('scripts')
    <script type="module">
        ...
        function incomesTables(id='', date1='', date2='') {
        ...
        jQuery(document).ready(function () {
            incomesTables({{ $incomeCategory->id }});
        })
        ...
        $(".btn-search").on("click", function () {
            ...
            jQuery(".datatable").DataTable().destroy();
            incomesTables({{ $incomeCategory->id }},date1, date2);
        })
